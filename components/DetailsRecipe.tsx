  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6 pb-20">
        {/* Title */}
        <motion.div
          className="sticky top-0 z-40 bg-background/90 backdrop-blur-md border-b border-border shadow-sm"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <h1 className="text-xl md:text-3xl font-bold text-center py-4 text-primary">
            {recipe.name}
          </h1>
        </motion.div>
